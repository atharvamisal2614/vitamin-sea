...
const CoupleCottage = () => {
        ...
        <div className=" flex justify-center items-start p-5">
            <div className="flex flex-col md:flex-row w-full ">
                <div className="w-full md:w-3/5 mb-5 md:mb-0">
                    <h1 className="text-4xl md:text-5xl text-gray-700 mb-5">Couple Rooms (Cottage)</h1>
                ...
                <div className="w-full md:w-2/5 p-5">
                    ...
                    <p className="mt-2">Designed for couples seeking privacy and relaxation.</p>
    ...
    <li><strong>2+1 (extra mattress available).</strong></li>
    <li><strong>Private courtyard and balcony for complete privacy.</strong></li>
    <li><strong>Comfortable double beds with cozy interiors.</strong></li>
    <li><strong>Perfect view of the beach and coconut trees from the balcony.</strong></li>
</ul>
